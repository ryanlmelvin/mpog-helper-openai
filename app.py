...
st.sidebar.write("They are helpful for synthesis and idea generation. They are predicting a response to what you say based on their training material (in this case pages from the internet).")
st.sidebar.write("You can trick generative AIs into saying whatever you want. If you succeed in tricking that AI, then what it says is something you created, not something it created.")
st.sidebar.write("As always, use your best judgment. An AI can do the wrong thing at the worst time.")
